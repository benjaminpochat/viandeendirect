...
class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorizeHttpRequestsCustomizer -> authorizeHttpRequestsCustomizer
                        ...
                        .requestMatchers("/sales/*/ordersSummaries").hasRole(ROLE_PRODUCER)
                        .requestMatchers("/sales/*/ordersInvoices").hasRole(ROLE_PRODUCER)
                        ...
                        .requestMatchers("/beefProduction/*/packageElementsLabel").hasRole(ROLE_PRODUCER)

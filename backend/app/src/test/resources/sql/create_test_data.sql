...
insert into package_lots (id, description, label, net_weight, quantity, quantity_sold, unit_price, production_id)
values (10000, 'Un coli avec un peu de tout', 'Le coli tradition', 10, 10, 2, 16, 1000);
insert into package_lots (id, description, label, net_weight, quantity, quantity_sold, unit_price, production_id)
values (10001, 'Un coli avec une majorité de steaks', 'Le coli cuisson rapide', 7, 10, 3, 16, 1000);

insert into beef_productions (id, production_type, producer_id, animal_identifier, warm_carcass_weight, animal_type, birth_date, birth_place, slaughter_date)
values (1001, 1, 1000, '2345', '350', null, '2020-02-13', 'Béchy', '2023-11-03');
insert into package_lots (id, description, label, net_weight, quantity, quantity_sold, unit_price, production_id)
values (10010, 'Un coli avec un peu de tout', 'Le coli tradition', 10, 12, 2, 16, 1001);
insert into package_lots (id, description, label, net_weight, quantity, quantity_sold, unit_price, production_id)
values (10011, 'Un coli avec une majorité de steaks', 'Le coli cuisson rapide', 9, 10, 7, 16, 1001);

insert into beef_productions (id, production_type, producer_id, animal_identifier, warm_carcass_weight, animal_type, birth_date, birth_place, slaughter_date)
values (2000, 1, 2000, '3456', '450', null, '2021-03-15', 'Gruffy', '2024-01-05');
insert into package_lots (id, description, label, net_weight, quantity, quantity_sold, unit_price, production_id)
values (20000, 'Un coli avec un peu de tout', 'Le coli tradition', 10, 7, 1, 16, 2000);
insert into package_lots (id, description, label, net_weight, quantity, quantity_sold, unit_price, production_id)
values (20001, 'Un coli avec que des steaks', 'Le petit coli steak', 5, 11, 0, 18, 2000);
...
insert into sales (id, delivery_address_line1, delivery_address_line2, delivery_address_name, delivery_city, delivery_start, delivery_stop, delivery_zip_code, seller_id)
values (1000, '1 place de la République', null, 'Metz Centre', 'Metz', timestamp '2023-12-10 17:00:00', timestamp '2023-12-10 18:00:00', '57000', 1000);
insert into sales_productions (sales_id, productions_id)
values (1000, 1000);

insert into sales (id, delivery_address_line1, delivery_address_line2, delivery_address_name, delivery_city, delivery_start, delivery_stop, delivery_zip_code, seller_id)
values (2000, '5 rue de l''église', 'derrière le présbytère', 'Peltre', 'Peltre', timestamp '2023-02-10 11:00:00', timestamp '2023-02-10 12:00:00', '57999', 2000);
insert into sales_productions (sales_id, productions_id)
values (2000, 2000);
...
insert into orders (id, customer_id, invoice_id, sale_id, status)
values (3000, 3000, null, 1000, 'PAYMENT_COMPLETED');
insert into order_items (id, quantity, unit_price, order_id, package_lot_id)
values (3000, 1, 16, 3000, 10000);

insert into orders (id, customer_id, invoice_id, sale_id, status)
values (4000, 4000, null, 1000, 'PAYMENT_COMPLETED');
insert into order_items (id, quantity, unit_price, order_id, package_lot_id)
